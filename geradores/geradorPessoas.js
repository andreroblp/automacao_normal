...
function gerarNomeMasculino() {
    return {
        "nome": nomesMasculinos[gerarNumero(9)][gerarNumero(9)] + " " + nomeMeio[gerarNumero(9)][gerarNumero(9)] + " " + sobrenome[gerarNumero(99)][gerarNumero(9)],
        "sexo": "Masculino",
        "cpf": cpf(),
        "cns": cns(),
        "cel": cel(),
...
function gerarNomeFerminino() {
    return {
        "nome": nomesFemininos[gerarNumero(9)][gerarNumero(9)] + " " + nomeMeio[gerarNumero(9)][gerarNumero(9)] + " " + sobrenome[gerarNumero(99)][gerarNumero(9)],
        "sexo": "Feminino",
        "cpf": cpf(),
        "cns": cns(),
        "cel": cel(),
...
function gerarNomeMasculinoComNomeSocial() {
    return {
        "nome": nomesMasculinos[gerarNumero(9)][gerarNumero(9)] + " " + nomeMeio[gerarNumero(9)][gerarNumero(9)] + " " + sobrenome[gerarNumero(99)][gerarNumero(9)],
        "sexo": "Masculino",
        "cpf": cpf(),
...
function gerarNomeFermininoComNomeSocial() {
    return {
        "nome": nomesFemininos[gerarNumero(9)][gerarNumero(9)] + " " + nomeMeio[gerarNumero(9)][gerarNumero(9)] + " " + sobrenome[gerarNumero(99)][gerarNumero(9)],
        "sexo": "Feminino",
        "cpf": cpf(),
...
export default function gerarPessoa(tipoPessoa, nomeSocial) {
    if (tipoPessoa === 0) {
