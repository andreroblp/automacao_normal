...
describe('Venda Normal', function () {
  ...
  it('Realizar Login', function () {
    ...
    cy.visit('https://portalweb-hom.preventsenior.com.br/vendas/assinaturaDigitalExterno/541059')
  })
  ...
  it('Assinatura Digital', function () {
    ...
    cy.contains('button', 'Gerar Boleto').click()
    cy.get('[class="fancybox-iframe"]')
      .within(() => {
        return cy.get('@print').should('have.been.calledOnce')
      })
